...
function RealtimeConfigBar({ isOnline, theme, setTheme, size }) {
    ...
    return (
        <Row md={2} style={{ margin: '20px 2px 2px 2px', padding: '20px', border: '1px solid #21325E', borderRadius: '10px' }}>
            ...
            <Col md={2} style={{ textAlign: 'center', padding: '8px', border: '1px solid #21325E', borderRadius: '10px', justifyContent: 'center', alignItems: 'center' }}>
                <FormText style={{ alignSelf: 'center', alignContent: 'center', justifyContent: 'center' }}>{size.current_size} / {size.max_size} mb</FormText>
            </Col>
        </Row>
    )
}
    ...
    return (
        <Container>
            ...
            <Col md={10} style={{ marginTop: '20px' }}>
                <RealtimeConfigBar theme={theme} setTheme={setTheme} size={size} isOnline={isOnline} setIsOnline={setIsOnline} />
                {isOnline &&
                    <ReactJson src={data}
